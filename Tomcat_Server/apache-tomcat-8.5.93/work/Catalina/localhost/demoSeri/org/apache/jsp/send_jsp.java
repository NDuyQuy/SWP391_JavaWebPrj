 ...
 * Generated at: 2023-10-16 07:09:54 UTC
...
public final class send_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    URL url = new URL("http://localhost:8080/demoSeri/receive.jsp");
    HttpURLConnection connection = (HttpURLConnection) url.openConnection();
    connection.setRequestMethod("POST");
    connection.setDoOutput(true);
    // Serialize the Person object and send it as the HTTP request body
    try {
    ...
    if (responseCode == HttpURLConnection.HTTP_OK) {
        out.println("Person sent successfully!");
        response.sendRedirect("receive.jsp");
    } else {
        out.println("Failed to send person.");
    }
