                            ...
                            <div class="col-xl-7 col-lg-12">
                                <div class="product-tab mb-40">
                                    ...
                                    <c:forEach var="mcate" items="${sessionScope.main_category_list}" begin="0" end="2">
                                        <li class="nav-item">
                                            <a class="nav-link" id="cate-tab${mcate.categoryID}" data-toggle="tab" href="#cate${mcate.categoryID}" role="tab" aria-controls="${mcate.categoryID}"
                                               aria-selected="false">${mcate.categoryName}</a>
                                        </li>
                                    </c:forEach>
                                </ul>
                            </div>
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab">
                                        ...
                                        <div class="tab-pane fade" id="cate${cate.categoryID}" role="tabpanel" aria-labelledby="cate-tab${cate.categoryID}">
                                            <c:set var="sclist" value="${productDao.getProductsByMainCateId(cate.categoryID)}"/>
